        ...
        if (message.getChatId() != null) {
            ...
            if (result.getSuccess()){
                ...
                if (message.hasPhoto()) {
                    ...
                    botService.pictureUpload(photoSizeList);
                ...
                if (message.hasDocument()){
                    botService.documentUpload(message.getDocument());
                    xabar="" +client.getUser().getFullName()+"\n"+
